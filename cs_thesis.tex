...
\begin{thebibliography}{10}
  ...
  \\\texttt{http://www.icub.org}
   ...
   \bibitem{cangelosi-action} V. Tikhanoff, A. Cangelosi, G. Metta Platform
  ...
  \bibitem{vernon}The iCub humanoid robot: an open platform for research in 
  embodied cognition, Giorgio Metta Giulio Sandini, David Vernon, Lorenzo Natale
  Francesco Nori

  \bibitem{xavier}Real-Time Parallel Processing of Grammatical Structure in the 
